            ...
            <div className="row row-main-page">
                <div className="card-main-page">
                    <div className="container">
                        ...
                        <Link className="btn btn-outline-dark main-text-link" to="/questions" style={{ textDecoration: 'none' }}>Questions</Link>
                    </div>
                </div>
                <div className="card-main-page login-card">
                    <div className="container">
                        ...
                        <Link className="btn btn btn-outline-dark main-text-link" to="/register" style={{ textDecoration: 'none' }}>Create account</Link>
                    </div>
                </div>
            </div>
        </div>
